...
export function LampshadeHero() {
  ...
  useEffect(() => {
    startTransition(async () => {
      const response = await fetch("/api/lampshade", {
        method: "GET",
    ...
    <>
      <div ref={ref}>
        <>
          <summary>
            <Category>
              <FadeDownStagger className="text-center">
                <TextAnimatedGradient> Abajures</TextAnimatedGradient>
                <p className="font-bold text-gray-800 dark:text-gray-400 text-center ">
                  Lindos Abajures para sua sala de estar , quarto & studio.
                </p>
              </FadeDownStagger>
            </Category>
          </summary>

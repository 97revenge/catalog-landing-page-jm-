        ...
        <summary>
          <Category>
            ...
            <p className="text-gray-800 dark:text-gray-400">
              ...
              excepcionais, criados para tornar seu dia a dia mais eficiente e
              agradável
            </p>
          </Category>
        </summary>
            ...
            <CarouselContent className="ml-2 md:-ml-4 ">
              {value.map((item: any, index: any) => {
                const handler = (value: any) => {
                  ...
                  return router.push(
                    `https://api.whatsapp.com/send?phone=${number}&text=Quero te compartilhar este produto:${item.title} na JM Luz e Arte ✨ *Link do Produto*: ${item.url} `
                  );
                };
                        ...
                        <Card className="group relative block overflow-hidden h-full rounded-xl shadow-lg">
                          ...
                          <div className="h-[270px]  flex items-start justify-between  flex-col relative border border-gray-100  p-6">
                            <svg
                              ...
                              height="32"
                              viewBox="0 0 24 24"
                              className="relative top-2 current-fill text-red-500"
                            >
                              <path
                                fill="currentColor"
